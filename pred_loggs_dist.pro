...
;;;;;;;;;;;;;;Figure out parameters
  ...
  IF (calibration eq 7) THEN BEGIN
     params=[16.99 & 0.51 & 0.19 & -1.52  & 2.80  & 0.18  & 42.87  & 2.37  & 0.16 & 1.036]
  ENDIF
  IF (calibration eq 8) THEN BEGIN
     params=[31.08 & 0.91 & 0.15 & -1.22  & 3.27  & 0.14  & 61.95  & 3.29  & 0.22 & 1.246]
  ENDIF
  ...
  IF (calibration eq 29) THEN BEGIN
     params=[41.40 & 0.36 & 0.37 & -1.01  & 1.82  & 0.19  & 61.93  & 2.91  & 0.21 & 1.299]
  ENDIF
